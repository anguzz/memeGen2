<script lang="ts">
    ...
    const icons: Record<string, Icon> = {
      ...
      linkedin: {
        link: "https://www.linkedin.com/in/asantoyo/",
        name: "LinkedIn",
      },
      email: {
        link: "mailto:santoyox714@gmail.com",
        name: "Email",
      },
      spotify: {
...
<div class="flex justify-evenly">
  ...
  <IconButton link={icons.github.link} name={icons.github.name}>
    <svg
      ...
      data-prefix="fab"
      data-icon="github"
      class="svg-inline--fa fa-github fa-w-16 {colorClass} {spacingClass} {sizeClass}"
      role="img"
  ...
  <IconButton link={icons.linkedin.link} name={icons.linkedin.name}>
    <svg
      ...
      data-prefix="fab"
      data-icon="linkedin"
      class="svg-inline--fa fa-linkedin fa-w-14 {colorClass} {spacingClass} {sizeClass}"
      role="img"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 448 512"
      ><path
  ...
  <IconButton link={icons.email.link} name={icons.email.name}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      class="{colorClass} {spacingClass} {sizeClass}"
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
    >
    ...
    <IconButton link={icons.spotify.link} name={icons.spotify.name}>
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fab"
            data-icon="spotify"
            class="svg-inline--fa fa-spotify fa-w-14 {colorClass} {spacingClass} {sizeClass}"
            role="img"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 190 190"
            ><path
